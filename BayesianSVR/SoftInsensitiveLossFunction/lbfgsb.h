...
#define s_copy(a,b,c,d) (strcpy((a),(b)))
	...
	/* Subroutine */ int dpofa_(
		doublereal* a,
		integer* lda, integer* n, integer* info)
	{
		/* System generated locals */
	...
	/* Subroutine */ int dtrsl_(
		doublereal* t,
		integer* ldt, integer* n,
		doublereal* b,
	...
	/* Subroutine */ int active_(
		integer* n,
		doublereal* l, doublereal* u,
		integer* nbd,
		doublereal* x,
		integer* iwhere, integer* iprint,
	...
	/* Subroutine */ int bmv_(
		integer* m,
		doublereal* sy, doublereal* wt,
		integer* col,
		doublereal* v, doublereal* p,
		integer* info)
	{
		/* System generated locals */
	...
	/* ======================== The end of bmv =============================== */
	/* Subroutine */ int cmprlb_(
		integer* n, integer* m,
		doublereal* x, doublereal* g, doublereal* ws, doublereal* wy, doublereal* sy, doublereal* wt, doublereal* z__, doublereal* r__, doublereal* wa,
		integer* index,
		doublereal* theta,
		integer* col, integer* head, integer* nfree,
		logical* cnstnd,
		integer* info)
	{
		/* System generated locals */
	...
	/* ======================= The end of cmprlb ============================= */
	/* Subroutine */ int errclb_(
		integer* n, integer* m,
		doublereal* factr, doublereal* l, doublereal* u,
		integer* nbd,
		char* task,
		integer* info, integer* k,
		ftnlen task_len)
	{
		/* System generated locals */
		integer i__1;
	...
	/* Subroutine */ int formt_(
		integer* m,
		doublereal* wt, doublereal* sy, doublereal* ss,
		integer* col,
		doublereal* theta,
		integer* info)
	{
	...
	/* ======================= The end of freev ============================== */
	/* Subroutine */ int hpsolb_(
		integer* n,
		doublereal* t,
		integer* iorder, integer* iheap)
	{
		/* System generated locals */
		integer i__1;
	...
	/* Subroutine */ int prn2lb_(
		...
		integer* nint,
		char* word,
		integer* iword, integer* iback,
		doublereal* stp, doublereal* xstep,
		ftnlen word_len)
	{
		/* Parameter adjustments */
		--g;
	...
	/* Subroutine */ int dcstep_(
		doublereal* stx, doublereal* fx, doublereal* dx, doublereal* sty, doublereal* fy,
		doublereal* dy, doublereal* stp, doublereal* fp, doublereal* dp,
		logical* brackt,
	...
	/* Subroutine */ int dcsrch_(
		doublereal* f, doublereal* g, doublereal* stp, doublereal* ftol, doublereal* gtol,
		doublereal* xtol, doublereal* stpmin, doublereal* stpmax,
		char* task,
		integer* isave,
		doublereal* dsave,
		ftnlen task_len)
	...
	/* ====================== The end of dcsrch ============================== */
	/* Subroutine */ int lnsrlb_(
		integer* n,
		doublereal* l, doublereal* u,
		integer* nbd,
		doublereal* x, doublereal* f, doublereal* fold, doublereal* gd, doublereal* gdold,
		doublereal* g, doublereal* d__, doublereal* r__, doublereal* t, doublereal* z__, doublereal* stp, doublereal* dnorm,
		doublereal* dtd, doublereal* xstep, doublereal* stpmx,
		integer* iter, integer* ifun, integer* iback, integer* nfgv, integer* info,
		char* task,
		logical* boxed, logical* cnstnd,
		char* csave,
		integer* isave,
		doublereal* dsave,
		ftnlen task_len,
	...
	/* Subroutine */ int cauchy_(
		integer* n,
		doublereal* x, doublereal* l, doublereal* u,
		integer* nbd,
		doublereal* g,
		integer* iorder, integer* iwhere,
		doublereal* t, doublereal* d__, doublereal* xcp,
		integer* m,
		doublereal* wy, doublereal* ws, doublereal* sy, doublereal* wt, doublereal* theta,
		integer* col, integer* head,
		doublereal* p, doublereal* c__, doublereal* wbp, doublereal* v,
		integer* nint, integer* iprint,
		doublereal* sbgnrm,
		integer* info,
		doublereal* epsmch)
	{
	...
	/* Subroutine */ int mainlb_(integer* n, integer* m,
		doublereal* x, doublereal* l, doublereal* u,
		integer* nbd,
		doublereal* f, doublereal* g, doublereal* factr, doublereal* pgtol, doublereal* ws, doublereal* wy,
		doublereal* sy, doublereal* ss, doublereal* wt, doublereal* wn, doublereal* snd, doublereal* z__,
		doublereal* r__, doublereal* d__, doublereal* t, doublereal* wa, integer* index, integer* iwhere, integer* indx2,
		char* task, integer* iprint, char* csave, logical* lsave, integer* isave, doublereal* dsave,
	...
	/* Subroutine */ int lbfgsb(integer* n, integer* m, doublereal* x, doublereal* l, doublereal* u, integer* nbd, doublereal* f,
		doublereal* g, doublereal* factr, doublereal* pgtol, doublereal* wa, integer* iwa, char* task,
		integer* iprint, char* csave, logical* lsave, integer* isave, doublereal* dsave, ftnlen task_len,
		ftnlen csave_len)
	{
		/* System generated locals */
		integer i__1;
